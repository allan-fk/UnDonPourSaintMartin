...
if ( typeof tldc.funnelSegments['299'] == 'undefined' ) {
  tldc.funnelSegments['299'] = [];
  var n=0;
	tldc.funnelSegments['299'][n++] = { 'seg':'2383373', 	'step':4, 'ievs':'2383357', 'conv':'0' };
	tldc.funnelSegments['299'][n++] = { 'seg':'2386256', 	'step':5, 'ievs':'2386174', 'conv':'0' };
	tldc.funnelSegments['299'][n++] = { 'seg':'5166753', 	'step':5, 'ievs':'2386174', 'conv':'0' };
	tldc.funnelSegments['299'][n++] = { 'seg':'2386265', 	'step':6, 'ievs':'2386250', 'conv':'758625' };
	tldc.funnelSegments['299'][n++] = { 'seg':'8461579', 	'step':5, 'ievs':'2386174', 'conv':'0' };
	tldc.funnelSegments['299'][n++] = { 'seg':'10044153', 	'step':4, 'ievs':'2383357', 'conv':'894638' };
...
for (var i = 0; i < scriptTags.length; i++) {
  ...
  if (undefined !== ssrc && null !== ssrc && ssrc.indexOf('fseg') !== -1 && ssrc.indexOf('299.js') !== -1) {  	
    ...
    //console.log('tlfseg:'+JSON.stringify(tldc.tlfseg));
    	if ( typeof tldc.tlfseg[qs.add] === 'undefined' ) {	    		  		
    		if ( processFunnelSegVal(qs.add,qs.val,'299',tldc.funnelSegments['299']) ) tldc.tlfseg[qs.add] = 1;  
    	}
    }
  }
}
